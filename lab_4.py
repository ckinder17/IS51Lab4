...
we first set max_tries = 3. Then we create a loop to iterate three times.
for each iteration, we ask the user for the answer (user input). then based on the answer the user gives, we check to see if
the user input matches the answer. if so, print "Correct!", then terminate the loop with a break statement.
if the user could not guess the correct answer within the max_tries, print "You have used up your allotment of guesses.",
...
def ask(question, answer, max_tries=3):
    ...
    if ans != answer:
        ...
        print("The correct answer is Saramento.")
